...
```bash
cd scripts
python transformer.py --csv ../logs/positions.csv --json ../experiments/experiment-test-2/calibration_results.json
```
...
python visualiser.py --experiment ./<generated_experiment_folder> --heatmap --stops
```
